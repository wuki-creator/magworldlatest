"""Generate VCC predictions from directed MagWorld v4 ensembles."""
...
def main() -> None:
    ...
    obs = pd.DataFrame(
        ...
        index=[f"magworld_v4_{i:06d}" for i in range(matrix.shape[0])],
    )
    ...
    prediction.uns["model"] = "MagWorldH1-v4-directed-reciprocal-bayesian"
